                    ...
                    <div className="bg-zinc-50 shadow-md dark:bg-[#131315] ring-1 ring-zinc-200 dark:ring-zinc-800 h-24 sm:h-32 w-full rounded-2xl flex flex-col flex-shrink-0">
                        ...
                        <div className="flex justify-end px-2 pb-1.5 sm:pr-2 sm:pb-2 flex-shrink-0 gap-1 sm:gap-2">
                            <button 
                                ...
                                className="cursor-pointer flex text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-1 sm:p-2 rounded-md transition-all duration-500 hover:bg-zinc-200 hover:text-zinc-700 dark:hover:bg-zinc-900 dark:hover:text-zinc-300"
                            >
                            ...
                            <button 
                                ...
                                className="bg-gradient-to-r from-blue-800 to-blue-600 hover:from-blue-700 hover:to-blue-500 text-white rounded-lg px-1.5 py-1 sm:p-2 transition-all duration-300"
                            >
